...
//        val x = mKChartView.getTextPaint().measureText(getValueFormatter().format(getMaxValue()) + " ")
    ...
    override fun foreachDrawChart(
        ...
        drawLine(
            ...
            ma5Paint,
            curIndex,
            curPoint.getMAVolumeByNum(5),
            lastPoint.getMAVolumeByNum(5),
            startX,
            stopX
        )
        drawLine(
            ...
            ma10Paint,
            curIndex,
            curPoint.getMAVolumeByNum(10),
            lastPoint.getMAVolumeByNum(10),
            startX,
            stopX
        )
    }
    ...
    public override fun getMaxValue(point: IVolume): Float {
        return Math.max(
            point.getVolume(),
            Math.max(point.getMAVolumeByNum(5), point.getMAVolumeByNum(10))
        )
    }
